...
from unified_agent.intent_router import detect_scenario, resolve_intent, resolve_rag_profile
from unified_agent.registry import LayerNode, NodeRegistry
from unified_agent.state import PreflightState, mark_blocked
...
class RoleContextNode(LayerNode):
    ...
    async def _fetch_tool_registry(self) -> list:
        ...
        """
        from unified_agent.tool_registry_sync import fetch_registry_async
    ...
    def _apply_disabled_from_definitions(definitions: list) -> int:
        ...
        返回被禁用的工具数量.
        """
        from unified_agent.tool_registry_sync import apply_disabled_tools
