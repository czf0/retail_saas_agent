...
复用: rag_settings (RAG_VECTOR_TOPK / RAG_KEYWORD_TOPK), langchain BM25Retriever, tokenizer.chinese_tokenize.
"""
...
def build_vector_retriever(vector_store: Any, top_k: Optional[int] = None) -> Any:
    ...
    Args:
        ...
        top_k: 召回数量, 默认 RAG_VECTOR_TOPK.
    """
    k = top_k or rag_settings.RAG_VECTOR_TOPK
...
def config_bm25_k(bm25: BM25Retriever, top_k: Optional[int] = None) -> BM25Retriever:
    ...
    """
    bm25.k = top_k or rag_settings.RAG_KEYWORD_TOPK
    return bm25
