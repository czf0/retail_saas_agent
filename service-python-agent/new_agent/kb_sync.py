...
- import 由 other_agent.obs / other_agent.rag 统一切换为 core.obs / new_agent.rag,
...
from new_agent.rag.synonym_client import invalidate_local_cache as invalidate_synonym_cache
