...
logger = get_logger("lc_llm_client")
...
class LCLLMClient:
    ...
    def sync_chat(
        ...
        with otel_tracer.span("lc_llm_sync_chat") as span:
    ...
    async def async_chat(
        ...
        used_model = model or llm_settings.LLM_MODEL
        with otel_tracer.span("lc_llm_async_chat") as span:
            span.set_attribute("gen_ai.operation.name", "chat")
            span.set_attribute("gen_ai.request.model", used_model)
    ...
    async def stream_chat(
        ...
        """
        used_model = model or llm_settings.LLM_MODEL
        with otel_tracer.span("lc_llm_stream_chat") as span:
            span.set_attribute("gen_ai.operation.name", "chat")
            span.set_attribute("gen_ai.request.model", used_model)
    ...
    async def batch_async_chat(
        ...
        used_model = model or llm_settings.LLM_MODEL
        with otel_tracer.span("lc_llm_batch_async_chat") as span:
